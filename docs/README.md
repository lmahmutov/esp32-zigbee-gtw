...
Прошивка v0.2.7. Аппаратная платформа: ESP32-S3 WROOM-1 (4MB flash, без PSRAM) + ESP32-H2 (NCP).
...
1. Прошить оба чипа через веб-флешер: https://77.91.79.32:8090
...
### Через веб-флешер
https://77.91.79.32:8090 — прошивка обоих чипов (S3 и H2) через USB из браузера. Требуется Chrome/Edge.

### Через USB
```bash
. /home/lenar/esp32/esp-sdk/esp-idf/export.sh
cd /home/lenar/esp32/esp32-gateway && idf.py flash -p /dev/ttyUSB0
cd /home/lenar/esp32/esp32-ncp && idf.py flash -p /dev/ttyUSB1
```
