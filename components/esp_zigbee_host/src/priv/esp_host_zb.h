...
#define ESP_ZNSP_SET_TC_POLICY                   0x0032  /*!< Set Trust Center policy: type(u16) + value(u8) */
...
#define ESP_ZNSP_ZDO_ACTIVE_EP                   0x0203  /*!< Active endpoint request */
#define ESP_ZNSP_ZDO_SIMPLE_DESC                 0x0204  /*!< Simple descriptor request */
#define ESP_ZNSP_APS_DATA_REQUEST                0x0300  /*!< Request the aps data */
#define ESP_ZNSP_APS_DATA_INDICATION             0x0301  /*!< Indication the aps data */
#define ESP_ZNSP_APS_DATA_CONFIRM                0x0302  /*!< Confirm the aps data */
...
/* esp_host_zb_endpoint_t is defined in esp_zigbee_core.h (public) */
